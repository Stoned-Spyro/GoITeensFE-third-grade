...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/greeter.js":[function(require,module,exports) {
...
var greeter = function greeter(username) {
  console.log("".concat(helloMessage, " ").concat(username));
};
...
var _require = require("./greeter"),
  hello = _require.hello,
  goodbye = _require.goodbye,
  greeter = _require.greeter;
console.log(hello());
console.log(goodbye());
greeter("Oleksii");
},{"./greeter":"src/greeter.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
